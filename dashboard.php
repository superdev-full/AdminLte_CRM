...
$session_last_active = isset($_SESSION['LAST_ACTIVE']) ? $_SESSION['LAST_ACTIVE'] : time();

if (!isset($_SESSION['AdminLogin']) || (time() - $session_last_active) > $session_timeout) {
    session_unset();
    session_destroy();
    header('Location: index.php'); // Ensure the correct redirection
    exit();
}
