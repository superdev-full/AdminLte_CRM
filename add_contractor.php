...
<head>
  ...
  <title>CRM - Add Contractor</title>
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="row">
           ...
           <form id="multi-step-form" action="add_contractor_data.php" method="POST">
            <div class="step" data-step="1">
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <input type="text" class="form-control" id="contractorname" placeholder="Contractor Name" name="contractorname" required>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="contractorid">Contractor Id</label>
                    <input type="text" class="form-control" id="contractorid" placeholder="Contractor Id" name="contractorid" required>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="startdate" placeholder="Contractor Start Date" name="contractorstartdate" required>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="enddate">Contractor End Date</label>
                    <input type="date" class="form-control" id="enddate" placeholder="Contractor End Date" name="contractorenddate" required>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <label for="address1">Address First Line</label>
                        <input class="form-control" type="text" id="address1" placeholder="Address First Line" name="addressfirstline" required>
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <div class="form-group">
                      <label for="address2">Address Second Line</label>
                        <input class="form-control" type="text" id="address2" placeholder="Address Second Line" name="addresssecondline" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select class="form-control select1" style="width: 100%;" name="state" required>
                      ...
                      <div class="col-sm-4">
                          <div class="form-group">
                            ...
                            <select class="form-control select1" style="width: 100%;" name="country" required>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control email-input" id="emailid" placeholder="Email Id" name="emailid" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="personname" id="address1" placeholder="Contact Person Name" name="contactpersonname" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="designation">Designation</label>
                        <input class="form-control" type="text" id="designation" placeholder="Designation" name="designation" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="mobilenumber" placeholder="Mobile Number" name="mobilenumber" required>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="form-group">
                          <label for="landlinenumber">Landline Number</label>
                          <input type="text" class="form-control" id="landlinenumber" placeholder="Landline Number" name="landlinenumber" required>
                        </div>
                      </div>
                      <div class="col-sm-1">
                        <div class="form-group">
                          <label for="extn">Extn</label>
                          <input type="text" class="form-control" id="extn" placeholder="Extn" name="extn" required>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label for="emailid">Email Id</label>
                          <input type="email" class="form-control email-input" id="emailid" placeholder="Email Id" name="contactpersonemailid" required>
                        </div>
                      </div>
                  </div>
                </div>
            ...
            <div class="step" data-step="3">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>PAN</label>
                    <input type="text" class="form-control" id="pan" placeholder="PAN" name="pannumber" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>TAN</label>
                    <input type="text" class="form-control" id="tan" placeholder="TAN" name="tannumber" required>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>GST</label>
                    <input type="text" class="form-control" id="gst"  placeholder="GST" name="gstnumber" required>
                  </div>
                </div>
              </div>
              <button class="btn btn-primary prev-step" data-step="2">Previous</button>
              <button type= "submit" name="submit" value="submit" class="btn btn-primary">Add Contractor</button>
            </div>
            </form>
           </div>
        </div>
