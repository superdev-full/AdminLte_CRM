...
<form id="deleteForm" action="delete_site.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="card">
                                    ...
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                        <?php 
                          $sql="SELECT * ,sites.id AS site_id FROM sites INNER JOIN clients ON sites.client_id=clients.id
                          ...
                          ?>
                                        ...
                                        <tr>
                                          <td><?php echo $row['site_id'] ?></td>
                                            <td><?php echo $row['sites_name'] ?></td>
                                            <td><?php echo $row['client_name'] ?></td>
                                            <td><?php echo $row['contact_mobile'] ?></td>
                                            <td><?php echo $row['email'] ?></td>
                                          
                                            <td>
                                            <a href="edit_site.php?id=<?php echo $row['site_id'] ?>"><i class="material-icons" id="deleteButton" onclick="showConfirmationModal()">edit</i> </a> 
                                            <a href="#" onclick="showDeleteConfirmation(<?php echo $row['site_id']; ?>)">
