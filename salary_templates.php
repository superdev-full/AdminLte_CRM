...
<head>
  ...
  <title>CRM - Salary Templates</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="text-md-right"> <!-- Align buttons to the right -->
                                    <a href="add_salary_template.php"  class="btn btn-primary">Add Template</a>
                  ...
                  <div class="card-body table-responsive p-0">
                    <table class="table table-head-fixed text-nowrap">
                      ...
                      <tr onclick="window.location.href=''">
                          ...
                          <td class="align-middle"><a href="update_designation.php?id=<?php echo $user_row['id']?>"><button type="button" class="btn btn-success mr-2" data-toggle="modal" data-target="#exampleModalCenter">Edit</button></a></td>
