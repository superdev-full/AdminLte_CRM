                ...
                <nav class="mt-4">
                   ...
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <a href="<?php echo base_url ?>admin/?page=generate" class="nav-link nav-generate">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <a href="<?php echo base_url ?>admin/?page=generate/list" class="nav-link nav-generate_list">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <a href="<?php echo base_url ?>admin/?page=templates" class="nav-link nav-templates">
