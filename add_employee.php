          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="bs-stepper mb-2">
                ...
                <form  action="add_employee_data.php" method="POST">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="examplefirstname" placeholder="First Name" name="employeeName" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control mt-2" id="examplemiddlename" placeholder="Middle Name" name="employeeMiddleName" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control mt-2" id="examplelastname" placeholder="Last Name" name="employeeLastName" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control mt-2" id="placeofbirth" placeholder="Place of Birth" name="placeOfBirth" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control mt-2" id="mothertongue" placeholder="Mother Tongue" name="motherTongue" required>
                            </div>
                          </div>
                                ...
                                <div class="row">
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control input" id="name" placeholder="Name" name="relativesName[]" autocomplete="off" data-items="8" required>
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label for="relation">Relation</label>
                                      <input type="text" class="form-control input" id="relation" placeholder="Relation" name="relativesRelation[]" autocomplete="off" data-items="8" required>
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    <div class="form-group ">
                                      <label for="dateofbirth">Date of Birth</label>
                                      <div class="input-group">
                                        <input type="date" class="form-control input" autocomplete="off" data-items="8" name="relativesDateOfBirth[]" required>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control input" id="occupation" placeholder="Occupation" name="occuption[]" autocomplete="off" data-items="8" required>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="number" class="form-control input" id="age" placeholder="Age" autocomplete="off" data-items="8" name="Age[]" required>
                                    </div>
                                  </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="employeeid" placeholder="Employee Id" name="employeeId" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="pfnumber" name="PFNumber" placeholder="PF Number" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="esi" placeholder="ESI" name="ESI" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="adhaar" placeholder="Aadhar Number" name="AadharNumber" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="driving" placeholder="Driving License Number" name="drivingLicenseNumber" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="bank" placeholder="Bank Name" name="bankName" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="account" placeholder="Account Number" name="AccountName" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="door" placeholder="Door Number" name="contactDoorNumber" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="street" placeholder="Street" name="contactStreet" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="area" placeholder="Area" name="contactArea" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="city" placeholder="City" name="contactCity" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="district" placeholder="District" name="contactDistrict" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="number" class="form-control" id="postal" placeholder="Postal Code" name="contactPostalCode" required>
                            </div>
                          </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="door">Door Number</label>
                              <input type="text" class="form-control" id="door" placeholder="Door Number" name="localDoorNumber" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="street"> Street</label>
                              <input type="text" class="form-control" id="street" placeholder="Street" name="localStreet" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="esi">Area </label>
                              <input type="text" class="form-control" id="area" placeholder="Area" name="localArea" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="city">City</label>
                              <input type="text" class="form-control" id="city" placeholder="City" name="localCity" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="district">District</label>
                              <input type="text" class="form-control" id="district" placeholder="District" name="localDistrict" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="postal">Postal Code</label>
                              <input type="number" class="form-control" id="postal" placeholder="Postal Code" name="localPostalCode" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="mobile" placeholder="Mobile Number" name="mobileNumber" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="landline" placeholder="Landline Number" name="landlineNumber" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="alternate" placeholder="Alternate Number" name="alternateNumber" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="spouse" placeholder="Spouse Number" name="spouseNumber" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="mother" placeholder="Mother Number" name="motherNumber" required>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="father" placeholder="Father Number" name="fatherNumber" required>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="email" class="form-control email-input" id="email" placeholder="Email id" name="emailID" required>
                            </div>
                          </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="degree" placeholder="Degree" name="degree[]" required>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="period" placeholder="Period" name="period[]" required>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="number" class="form-control" id="marks" placeholder="Marks" name="Marks[]" required>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="company" placeholder="Company name" name="CompanyName[]" required>
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="period2" placeholder="Period" name="employeePeriod[]" required>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="reason" placeholder="Reason for leaving" name="reasonForLeaving[]" required>
                                    </div>
                                  </div>
