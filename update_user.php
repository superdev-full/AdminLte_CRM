      ...
      <div class="container-fluid">
          ...
          <div class="row">
           ...
           <form method="post" action="">
                <?php
                  $id=$_GET['id'];
                  $user_sql=mysqli_query($conn,"SELECT * from `user_details` where id='$id'");
                  while($user_row=mysqli_fetch_array($user_sql))
                  {
                    ...
                    $uroll=$user_row['user_role'];
                    $ustatus=$user_row['status'];
                  }
                ?>
                      ...
                      <div class="col-md-12">
                         <div class="form-group">
                            ...
                            <select class="form-control" name="roll">
                              ...
                              ?>
                              <option value="<?php echo $row['id']; ?>" <?php echo $row['id'] == $uroll ? "selected" : "" ?>><?php echo $row['roll_name']; ?></option>
                              <?php } ?>
                            </select>
                        </div>
                      </div>
