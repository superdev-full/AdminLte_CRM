...
if(isset($_POST['update'])){
    ...
    $name=$_POST['type'];
    $uemail=$_POST['name'];
    $upassword=$_POST['note'];
    
    
    $quer="update designation set type='$name',name='$uemail',note='$upassword' where id='$id'";
      ...
      <div class="container-fluid">
          ...
          <div class="row">
           ...
           <form method="post" action="">
                <?php
                  $id=$_GET['id'];
                  $user_sql=mysqli_query($conn,"select * from designation where id='$id'");
                  while($user_row=mysqli_fetch_array($user_sql))
                  {
                    $uname=$user_row['type'];
                    $uemail=$user_row['name'];
                    $upassword=$user_row['note'];
                  }
                ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          ...
                          <div class="form-check pr-5">
                                    <input class="form-check-input" type="radio"  name="type" value="Back Office" <?php echo ($uname=='Back Office')?'checked':'' ?> >
                                    <label class="form-check-label" for="office">Back Office</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input"  type="radio"  name="type" value="Site" <?php echo ($uname=='Site')?'checked':'' ?> >
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $uemail; ?>" id="clientid" placeholder="Client Id" value="<?php echo $uemail; ?>" name="name">
                          </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $upassword; ?>" id="startdate" placeholder="Client Start Date" value="<?php echo $upassword; ?>" name="note">
                          </div>
                        </div> 
                    </div>
