...
$sites_name=$_POST['sites_name'];
$sites_id=$_POST['sites_id'];
$client_start=$_POST['client_start'];
$client_end=$_POST['client_end'];
...
$update="UPDATE `sites` SET `sites_name`='$sites_name',`sites_id`='$sites_id',`client_start`='$client_start',`client_end`='$client_end',`address_first`='$address_first',`address_second`='$address_second',`city`='$city',`state`='$state',`country`='$country',`email`='$email',`website`=$website,`contact_name`='$contact_name',`contact_designation`='$contact_designation',`contact_mobile`='$contact_mobile',`contact_landline`='$contact_landline',`contact_extn`='$contact_extn',`email_id`='$email_id',`pan`='$pan',`gst`='$gst',`tan`='$tan' WHERE id=$id";
            ...
            <form id="multi-step-form" method="post">
                ...
                <div class="step" data-step="1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                          ...
                          <input type="text" class="form-control" id="contractorname" placeholder="Site Name" value="<?php echo $row['sites_name'] ?>" >
                          </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="contractorid" placeholder="Site Id" value="<?php echo $row['sites_id'] ?>" >
                          </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="startdate" placeholder="Site Start Date" value="<?php echo $row['client_start'] ?>">
                          </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="enddate" placeholder="Site End Date" value="<?php echo $row['client_end'] ?>">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-12">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="exampleCheck1" style="display: inline-block;">Copy from Client<br> <h5 style="display: inline;">Address</h5></label>
                            </div>
                          </div>
                          ...
                          <div class="col-sm-12">  
                            ...
                            <label for="address1">Address First Line</label>
                              <input class="form-control" type="text" id="address1" placeholder="Address First Line" value="<?php echo $row['address_first'] ?>">
                            </div>
                          </div>
                          ...
                          <div class="col-sm-12">
                            ...
                            <label for="address2">Address Second Line</label>
                              <input class="form-control" type="text" id="address2" placeholder="Address Second Line" value="<?php echo $row['address_second'] ?>">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="city" placeholder="City" value="<?php echo $row['city'] ?>" name="city" require>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="state" placeholder="State" value="<?php echo $row['state'] ?>" name="state" require>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="country" placeholder="Country" value="<?php echo $row['country'] ?>" name="country" require>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="email" class="form-control" id="emailid" placeholder="Email Id" value="<?php echo $row['email'] ?>">
                            </div>
                          </div>
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label>Website</label>
                              <input type="text" class="form-control" id="website" placeholder="Website" value="<?php echo $row['website'] ?>">
                            </div>
                          </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck2" style="display: inline-block;">Copy from Client<br> <h5 style="display: inline;">Contact</h5></label>
                            </div>
                          </div>
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="personname" id="address1" placeholder="Contact Person Name" value="<?php echo $row['contact_name'] ?>">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label for="designation">Designation</label>
                              <input class="form-control" type="text" id="designation" placeholder="Designation" value="<?php echo $row['contact_designation'] ?>">
                            </div>
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="mobilenumber" placeholder="Mobile Number" value="<?php echo $row['contact_mobile'] ?>">
                              </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="landlinenumber" placeholder="Landline Number" value="<?php echo $row['contact_landline'] ?>">
                              </div>
                            </div>
                            ...
                            <div class="col-sm-1">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="extn" placeholder="Extn" value="<?php echo $row['contact_extn'] ?>">
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="emailid" placeholder="Email Id" value="<?php echo $row['email_id'] ?>">
                              </div>
                            </div>
                ...
                <div class="step" data-step="3">
                        ...
                        <div class="form-check">
                                ...
                                <h2 style="display: inline;">Step 3: Tax Information</h2></label>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                            <label>PAN</label>
                            <input type="text" class="form-control" id="pan" placeholder="PAN" value="<?php echo $row['pan'] ?>">
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                            <label>TAN</label>
                            <input type="text" class="form-control" id="tan" placeholder="TAN" value="<?php echo $row['tan'] ?>">
                            </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                            <label>GST</label>
                            <input type="text" class="form-control" id="gst"  placeholder="GST" value="<?php echo $row['gst'] ?>">
                            </div>
                            </div>
